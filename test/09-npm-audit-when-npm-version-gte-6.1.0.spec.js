                    ...
                    .then((result) => {
                        const expected = {
                            ...
                            'advisories': {
                                '577': {
                                    'findings': [
                                        { 'version': '4.17.4', 'paths': ['ban-sensitive-files>ggit>lodash'] },
                                        { 'version': '4.16.4', 'paths': ['lodash', 'nsp>inquirer>lodash'] },
                                        { 'version': '3.10.1', 'paths': ['nsp>cli-table2>lodash'] },
                                    ],
                                    'id': 577,
                                    'created': '2018-04-24T14:27:02.796Z',
                                    'updated': '2018-04-24T14:27:13.049Z',
                                ...
                                '1065': {
                                    ...
                                    'deleted': null,
                                    'title': 'Prototype Pollution',
                                    'found_by': { 'link': '', 'name': 'Snyk Security Team' },
                                    'reported_by': { 'link': '', 'name': 'Snyk Security Team' },
                                    'module_name': 'lodash',
                                    'cves': ['CVE-2019-10744'],
